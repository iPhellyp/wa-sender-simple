...
import { listInternalLabeledIdentities } from "@/src/lib/internal-api/services";
...
export async function GET(request: NextRequest, context: { params: Promise<{ id: string }> }) {
  return withInternalApi(async () => {
    ...
    return internalJson(await listInternalLabeledIdentities(validateResourceId(id, "instanceId")));
  })(request);
}
